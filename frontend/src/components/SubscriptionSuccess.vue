  ...
  <div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
      ...
      <p class="text-gray-600 mb-6">
        Congratulations! You're now verified. Your blue checkmark will appear shortly.
      </p>
...
const getCurrentUser = () => {
  return authStore.currentUser || JSON.parse(localStorage.getItem('user') || 'null')
}
...
onMounted(() => {
  ...
  const refreshUserData = async () => {
    try {
      ...
      if (response.data.success && response.data.isVerified && authStore.currentUser) {
